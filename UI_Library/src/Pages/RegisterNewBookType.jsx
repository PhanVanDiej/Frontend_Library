    ...
    return (
        <div>
            ...
            <div className="main-content-register-BookTitle">
                <h2 className="title-page">Đăng ký thể loại sách mới</h2>
                <div className="form-regis-wrapper">
                    <form className="form-primary" id="registerNewBookTypeForm" onSubmit={(e) => {
                        e.preventDefault();
                        onSubmit();
                    }}>
                        ...
                        <input className="submit-btn action-btn" type="submit" />
